...
extension User {
    static var MOCK_USERS: [User] = [
        User(id: NSUUID().uuidString, username: "batman", profileImageUrl: nil, fullname: "Bruce Wayne" , bio: "Gotham's dark knight", email: "batman@gmail.com"),
        User(id: NSUUID().uuidString, username: "Ahmed", profileImageUrl: nil, fullname: nil , bio: "Testing bio 1", email: "batman@gmail.com"),
